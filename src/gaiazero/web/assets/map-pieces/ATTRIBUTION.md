# Gaia Project map-piece artwork
...
- `icons.png`: the Ivits space-station marker.

`scripts/build_bga_map_pieces.py` validates the source SHA-256 values before
copying the sheets into the runtime asset directory. The original artwork and
component designs remain the property of their respective copyright holders.
