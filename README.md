...
作为官方比赛裁决器。`standard-v12` 统一了 BGA 板块编号、科研逐级收益、初始科研收益、公共能量与 Q.I.C. 行动、学院类型及助推特殊行动，并加入 Taklons 脑石、Terrans 行星研究院的盖亚阶段资源兑换，以及 Lantids 共存矿场和行星研究院奖励；旧版检查点的状态语义不同，不能直接沿用。
